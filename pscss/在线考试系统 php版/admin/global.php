...
function makepage($totalnum,$pernum,$url=''){
	...
	if ($temp==' ') $temp='0';
	return array($page,$start,'每页 '.$pernum.' 条，第 '.$page.' 页 [ <a href="'.$selfurl.'?page=1'.$url.'" title="首页" ><img src="images/nav01.gif" border="0"></a><a href="'.$selfurl.'?page='.($page-$settings['pagenum']).$url.'" title="上'.$settings['pagenum'].'页"><img src="images/nav02.gif" border="0"></a><a href="'.$selfurl.'?page='.($page-1).$url.'" title="上一页"><img src="images/nav03.gif" border="0"></a>'.$temp.'<a href="'.$selfurl.'?page='.($page+1).$url.'" title="下一页"><img src="images/nav04.gif" border="0"></a><a href="'.$selfurl.'?page='.($page+$settings['pagenum']).$url.'" title="下'.$settings['pagenum'].'页"><img src="images/nav05.gif" border="0"></a><a href="'.$selfurl.'?page='.$pagecount.$url.'" title="尾页"><img src="images/nav06.gif" border="0"></a></font> ] 共 '.$pagecount.' 页，总计 '.$totalnum.' 条');
}
